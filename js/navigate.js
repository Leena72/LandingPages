...
function section17_18(e){
  ...
  $("#s4-car").onPositionChanged(function () {
    ...
    if ($('#s4-car').position().left == 278 ||
        $('#s4-car').position().left == 265 ||
        $('#s4-car').position().left == 260 ||
        $('#s4-car').position().left == 225 ||
        $('#s4-car').position().left == 296 ||
        $('#s4-car').position().left == 315 ||
        $('#s4-car').position().left == 342 ||
        $('#s4-car').position().left == 413  ||
        $('#s4-car').position().left == 308) {
            section4_5()
    }
...
$("#s7-car").onPositionChanged(function () {
    ...
    if ($('#s7-car').position().left == 278 ||
        $('#s7-car').position().left == 265 ||
        $('#s7-car').position().left == 260 ||
        $('#s7-car').position().left == 225 ||
        $('#s7-car').position().left == 296 ||
        $('#s7-car').position().left == 315 ||
        $('#s7-car').position().left == 342 ||
        $('#s7-car').position().left == 413  ||
        $('#s7-car').position().left == 308) {
            section7_8()
    }
...
$("#s10-car").onPositionChanged(function () {
    ...
    if ($('#s10-car').position().left == 278 ||
        $('#s10-car').position().left == 265 ||
        $('#s10-car').position().left == 260 ||
        $('#s10-car').position().left == 225 ||
        $('#s10-car').position().left == 296 ||
        $('#s10-car').position().left == 315 ||
        $('#s10-car').position().left == 342 ||
        $('#s10-car').position().left == 413  ||
        $('#s10-car').position().left == 308) {
            section10_11()
    }
...
$("#s12-car").onPositionChanged(function () {
    ...
    if ($('#s12-car').position().left == 278 ||
        $('#s12-car').position().left == 265 ||
        $('#s12-car').position().left == 260 ||
        $('#s12-car').position().left == 225 ||
        $('#s12-car').position().left == 296 ||
        $('#s12-car').position().left == 315 ||
        $('#s12-car').position().left == 342 ||
        $('#s12-car').position().left == 413  ||
        $('#s12-car').position().left == 308) {
            section12_13()
    }
