...
var p14_content = document.getElementById('p14-content-1').innerText;

// var p15_content = document.getElementById('p15-content-1').innerText + document.getElementById('p15-content-2').innerText

var p15_content = document.getElementById('p15-content-1').innerText;
...
var p18_content = `CMO-C-Suite Partnership:
The Key to Succeed in the race of digital transformation. To get access to entire report, checkout `+ "https://leena72.github.io/LandingPages/Files/Infosys_Race%20Track_Mob%20Version.pdf"
